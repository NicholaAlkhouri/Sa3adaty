...
namespace MVCForum.Services
{
    public partial class MembershipService : IMembershipService
    {
        ...
        {
            //Changed by nichola to integrate with Sa3adaty Membership
        ...
        {
            return System.Web.Helpers.Crypto.HashPassword(plainText);
            //Changed by nichola to sync with Sa3adaty Membsership
        ...
        public bool ValidateUser(string userName, string password, int maxInvalidPasswordAttempts)
        {
            ...
            var passwordMatches =  System.Web.Helpers.Crypto.VerifyHashedPassword(user.Password,password);
        ...
        /// <returns></returns>
        public IList<MembershipUser> GetUsersById(List<int> guids)
        {
        ...
        public bool ChangePassword(MembershipUser user, string oldPassword, string newPassword)
        {
            ...
            if (!System.Web.Helpers.Crypto.VerifyHashedPassword(existingUser.Password ,oldPassword )	)
            {
