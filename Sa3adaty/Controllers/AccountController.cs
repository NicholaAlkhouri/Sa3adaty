...
namespace Sa3adaty.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            return View(new SignInUpModel() { Subscribe = true});
        }
        ...
        public ActionResult Login(SignInUpModel model, string returnUrl)
        {
            ...
            model.Password = "كلمة السر خاطئة";
            model.tab = 0;
        ...
        public ActionResult Register(string returnUrl)
        {
            ...
            ViewBag.Countries = servicesManager.CountryFrontService.GetOnlineCountries();
            return View("Login",new SignInUpModel() { Subscribe = true ,tab=1});
        }
        ...
        //    if (ModelState.IsValid)
        //    {
        //        int user_id = servicesManager.AccountService.IsUserExist(model.UserName);
        //        // Check if user already exists
        //        if (user_id < 0)
        //        {
        //            // Insert name into the profile table
        //          //  servicesManager.AccountService.AddUser(model.UserName,m);
