$(function () {
    ...
    $(listrolecbholder).click(function () {
        ...
        $.ajax({
            url: app_base + 'ForumAdmin/Account/UpdateUserRoles',
            type: 'POST',
            data: strung,
    ...
    $('span.permissioncheckbox').click(function () {
        ...
        $.ajax({
            url: app_base + 'ForumAdmin/Permissions/UpdatePermission',
            type: 'POST',
            data: strung,
            contentType: 'application/json; charset=utf-8',
            success: function (data) {
    ...
    $('span.saveresource').click(function (e) {
        ...
        if ((newvalue != null && newvalue != "") && (newvalue != oldvalue)) {
            ...
            $.ajax({
                url: app_base + 'ForumAdmin/AdminLanguage/UpdateResourceValue',
                type: 'POST',
                data: strung,
                contentType: 'application/json; charset=utf-8',
                error: function (xhr, ajaxOptions, thrownError) {
    ...
    $('span.saveresourcekey').click(function (e) {
        ...
        if ((newvalue != null && newvalue != "") && (newvalue != oldvalue)) {
            ...
            $.ajax({
                url: app_base + 'ForumAdmin/AdminLanguage/UpdateResourceKey',
                type: 'POST',
                data: strung,
                contentType: 'application/json; charset=utf-8',
                error: function (xhr, ajaxOptions, thrownError) {
    ...
    $('span.savebannedword').click(function (e) {
        ...
        if ((newvalue != null && newvalue != "") && (newvalue != oldvalue)) {
            ...
            $.ajax({
                url: app_base + 'ForumAdmin/BannedWord/AjaxUpdateWord',
                type: 'POST',
                data: strung,
                contentType: 'application/json; charset=utf-8',
                error: function (xhr, ajaxOptions, thrownError) {
    ...
    $('span.savebannedemail').click(function (e) {
        ...
        if ((newvalue != null && newvalue != "") && (newvalue != oldvalue)) {
            ...
            $.ajax({
                url: app_base + 'ForumAdmin/BannedEmail/AjaxUpdateEmail',
                type: 'POST',
                data: strung,
                contentType: 'application/json; charset=utf-8',
                error: function (xhr, ajaxOptions, thrownError) {
    ...
    $('span.savetag').click(function (e) {
        ...
        if ((newvalue != null && newvalue != "") && (newvalue != oldvalue)) {
            ...
            $.ajax({
                url: app_base + 'ForumAdmin/AdminTag/UpdateTag',
                type: 'POST',
                data: strung,
                contentType: 'application/json; charset=utf-8',
                error: function (xhr, ajaxOptions, thrownError) {
...
function AddModerateAjaxCalls() {
    ...
    $(".showmoretopics").click(function (e) {
        ...
        $.ajax({
            url: app_base + 'ForumAdmin/Moderate/GetMoreTopics',
            type: 'POST',
            dataType: 'html',
            data: strung,
            contentType: 'application/json; charset=utf-8',
    ...
    $(".showmoreposts").click(function (e) {
        ...
        $.ajax({
            url: app_base + 'ForumAdmin/Moderate/GetMorePosts',
            type: 'POST',
            dataType: 'html',
            data: strung,
            contentType: 'application/json; charset=utf-8',
...
function AddModerateClickEvents() {
    ...
    if (approvetopic.length > 0) {
        approvetopic.click(function (e) {
            ...
            $.ajax({
                url: app_base + 'ForumAdmin/Moderate/ModerateTopic',
                type: 'POST',
                data: strung,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
    ...
    if (approvepost.length > 0) {
        approvepost.click(function (e) {
            ...
            $.ajax({
                url: app_base + 'ForumAdmin/Moderate/ModeratePost',
                type: 'POST',
                data: strung,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
