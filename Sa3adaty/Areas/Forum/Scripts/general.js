...
$(function () {
    ...
    if (topicName.length > 0) {
        topicName.focusout(function () {
            ...
            if (length > 5) {
                ...
                $.ajax({
                    url: app_base + 'Forum/Topic/GetSimilarTopics',
                    type: 'POST',
                    dataType: 'html',
    ...
    if (createTopicCategoryDropdown.length > 0) {
        ...
        createTopicCategoryDropdown.change(function (e) {
            ...
            if (catId != "") {
                ...
                $.ajax({
                    url: app_base + 'Forum/Topic/CheckTopicCreatePermissions',
                    type: 'POST',
                    dataType: 'json',
                    data: { catId: catId },
                    success: function (data) {
    ...
    $(".showmoreposts").click(function (e) {
        ...
        $.ajax({
            url: app_base + 'Forum/Topic/AjaxMorePosts',
            type: 'POST',
            dataType: 'html',
            data: strung,
    ...
    $(".privatemessagedelete").click(function (e) {
        ...
        $.ajax({
            url: app_base + 'Forum/PrivateMessage/Delete',
            type: 'POST',
            data: strung,
            contentType: 'application/json; charset=utf-8',
            success: function (data) {
    ...
    $(".emailsubscription").click(function (e) {
        ...
        $.ajax({
            url: app_base + 'Forum/Email/Subscribe',
            type: 'POST',
            data: strung,
            contentType: 'application/json; charset=utf-8',
            success: function (data) {
    ...
    $(".emailunsubscription").click(function (e) {
        ...
        $.ajax({
            url: app_base + 'Forum/Email/UnSubscribe',
            type: 'POST',
            data: strung,
            contentType: 'application/json; charset=utf-8',
            success: function (data) {
    ...
    $(".pollvotebutton").click(function (e) {
        ...
        $.ajax({
            url: app_base + 'Forum/Poll/UpdatePoll',
            type: 'POST',
            dataType: 'html',
            data: strung,
            contentType: 'application/json; charset=utf-8',
...
function SortWhosOnline() {
    $.getJSON(app_base + 'Forum/Members/LastActiveCheck');
}
...
function AddPostClickEvents() {
    ...
    $(".solutionlink").click(function (e) {
        ...
        $.ajax({
            url: app_base + 'Forum/Vote/MarkAsSolution',
            type: 'POST',
            data: strung,
            contentType: 'application/json; charset=utf-8',
            success: function (data) {
...
function ShowExpandedVotes() {
    ...
    if (expandVotes.length > 0) {
        expandVotes.click(function (e) {
            ...
            $.ajax({
                url: app_base + 'Forum/' + 'Vote/GetVotes',
                type: 'POST',
                dataType: 'html',
                data: strung,
                contentType: 'application/json; charset=utf-8',
    ...
    if (showVoters.length > 0) {
        ...
        showVoters.click(function (e) {
            ...
            if (voterBox.is(":visible")) {
                ...
                $.ajax({
                    url: app_base + 'Forum/' + 'Vote/GetVoters',
                    type: 'POST',
                    dataType: 'html',
                    data: strung,
                    contentType: 'application/json; charset=utf-8',
...
function BadgeMarkAsSolution(postId) {
    ...
    $.ajax({
        url: app_base + 'Forum/' + 'Badge/MarkAsSolution',
        type: 'POST',
        data: strung,
        contentType: 'application/json; charset=utf-8',
        success: function (data) {
...
function BadgeVoteUp(postId) {
    ...
    $.ajax({
        url: app_base + 'Forum/' + 'Badge/VoteUpPost',
        type: 'POST',
        data: strung,
        contentType: 'application/json; charset=utf-8',
        success: function (data) {
...
function BadgeVoteDown(postId) {
    ...
    $.ajax({
        url: app_base + 'Forum/' + 'Badge/VoteDownPost',
        type: 'POST',
        data: strung,
        contentType: 'application/json; charset=utf-8',
        success: function (data) {
